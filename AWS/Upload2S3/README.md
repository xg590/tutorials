### Screenshot 
![alt text](https://github.com/xg590/tutorials/blob/master/AWS/Upload2S3/s3.png?raw=true "s3") 
...
### Install Apache2 && Enable Common Gateway Interface Daemon
```shell
# As root
...
```
### Put AWS Access Key in cgi-bin Folder
```shell
# As root
