...
* Ubuntu 22045 (Don't use 24043 now cause it's not working)
  ...
  sudo su
  apt install -y strongswan network-manager-strongswan libcharon-extra-plugins
  ...
  * Bring the VPN down
  ...
  ```sh
  sudo nmcli connection down IKEv2_123
  ```
